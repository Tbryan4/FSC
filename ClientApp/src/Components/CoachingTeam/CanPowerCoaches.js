...
import BaseCoachImg1 from "../../assets/coaching-staff/brodie-case.jpg"
...
export type CanPowerCoachesProps = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const CanPowerCoachesDefaults: Props = {
    tagline: "coaches",
    heading: "Star Skate",
...
export const CanPowerCoaches: React.FC<CanPowerCoachesProps> = (props) => {
    const { tagline, heading, description, teamMembers, footer } = {
        ...CanPowerCoachesDefaults,
        ...props,
    };
...
CanPowerCoaches.displayName = "Team2";
