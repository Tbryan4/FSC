...
export type StarSkateCoachesProps = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const StarSkateCoachesDefaults: Props = {
    tagline: "coaches",
    heading: "Star Skate",
    ...
    teamMembers: [
        ...
        {
            image: {
                src: SupplementalCoachImg1,
                alt: SupplementalCoachImg1,
            },
        ...
        {
            image: {
                src: SupplementalCoachImg2,
                alt: SupplementalCoachImg2,
            },
...
export const StarSkateCoaches: React.FC<StarSkateCoachesProps> = (props) => {
    const { tagline, heading, description, teamMembers, footer } = {
        ...StarSkateCoachesDefaults,
        ...props,
    };
...
StarSkateCoaches.displayName = "Team2";
