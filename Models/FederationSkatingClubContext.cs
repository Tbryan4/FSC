...
{
    public partial class FederationSkatingClubContext : DbContext
    {
        public FederationSkatingClubContext()
        {
        }

        public FederationSkatingClubContext(DbContextOptions<FederationSkatingClubContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Server=tcp:federation-skating-sql-server.database.windows.net,1433;Initial Catalog=FederationSkatingClub;Persist Security Info=False;User ID=sqladmin;Password=Jazzwinder258!;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<BuildVersion>(entity =>
            {
                entity.HasKey(e => e.SystemInformationId)
                    .HasName("PK__BuildVer__35E58ECA3631C493");
